...
/**
 * Utility for building {@link TemporalRequest} objects from temporal query parameters.
 *
 * <p>Supports time relations: {@code between}, {@code during}, {@code after}, {@code before}.
 * Validates that required parameters are present and that time ranges are valid.
 */
public class TemporalRequestHelper {

  private static final Logger LOGGER = LogManager.getLogger(TemporalRequestHelper.class);

  private TemporalRequestHelper() {}
