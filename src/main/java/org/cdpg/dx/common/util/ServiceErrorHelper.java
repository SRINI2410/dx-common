 ...
 *
 * <p>Eliminates the repetitive {@code .recover(err -> { ... })} pattern
 * that appears across service implementations.
 *
 * <h3>Usage:</h3>
 * <pre>{@code
 * // Before (6 lines):
...
public final class ServiceErrorHelper {
  ...
  /**
   * Maps {@link NoRowFoundException} to {@link DxNotFoundException}.
   *
  ...
  /**
   * Maps {@link UniqueConstraintViolationException} to {@link DxConflictException}.
   *
  ...
  /**
   * Maps both {@link NoRowFoundException} and {@link UniqueConstraintViolationException}.
   *
