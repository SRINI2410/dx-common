      ...
      switch (this.queryType) {
        ...
        case MATCH_PHRASE:
          return MatchPhraseQuery.of(
                  mp ->
                      mp.field((String) queryParameters.get(FIELD))
                          .query(queryParameters.get(VALUE).toString()))
              ._toQuery();
        case TERM:
          return TermQuery.of(
        ...
        case GEO_BOUNDING_BOX:
          return GeoBoundingBoxQuery.of(
                  g ->
                      g.field((String) queryParameters.get(FIELD))
                          .boundingBox(
                              bb ->
                                  bb.tlbr(
                                      tlbr ->
          ...
          return MultiMatchQuery.of(
                  m -> {
                    m.query((String) queryParameters.get("query"))
                        ...
                        .boost(
                            Float.parseFloat(
                                (String) queryParameters.getOrDefault("boost", "1.0")));
          ...
          return RangeQuery.of(
                  r ->
                      r.date(
                          DateRangeQuery.of(
                              dr -> {
                                DateRangeQuery.Builder builder =
                                    new DateRangeQuery.Builder()
                                        .field(queryParameters.get(FIELD).toString());

                                Map<String, Consumer<String>> rangeConditions =
                                    Map.of(
                                        GREATER_THAN_EQUALS,
                                        builder::gte,
                                        LESS_THAN_EQUALS,
