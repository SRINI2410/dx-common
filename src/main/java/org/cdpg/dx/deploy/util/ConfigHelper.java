...
public class ConfigHelper {
  ...
  /**
   * Merges required configs into each module config based on the "required" field. If a required
   * config is a JsonObject, its fields are merged into the Verticle config.
   *
